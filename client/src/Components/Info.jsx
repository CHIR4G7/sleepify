...
const Info = ({ data }) => {
  return (
    <div className="relative z-0">
      <div className="w-[50px] h-[50px] sm:w-[90px] sm:h-[90px] lg:w-[90px] lg:h-[90px] flex flex-col">
        <div
          className={`w-[90px] h-[200px] sm:w-[100px] sm:h-[200px] lg:w-[200px] lg:h-[225px] absolute`}
        >
          <div
            className={`card  text-gray-300 w-[clamp(260px,80%,300px)] hover:brightness-90 transition-all cursor-pointer group bg-gradient-to-tl from-gray-900 to-gray-950 hover:from-gray-800 hover:to-gray-950 border-r-2 border-t-2 border-gray-900 m-4 rounded-xl relative ${data.id % 2 !== 0 ? "lg:top-[-340px] sm:top-[-350px] top-[-350px]" : "lg:top-[90px] sm:top-[100px] top-[80px]"} left-[-50px]`}
          >
        ...
        <div className="absolute w-[90px] sm:w-[90px] lg:w-[90px] h-[90px] rounded-full">
